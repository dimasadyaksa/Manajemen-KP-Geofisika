    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('user/read/'.$user->idUser),'Read'); 
				echo ' | '; 
				echo anchor(site_url('user/update/'.$user->idUser),'Update'); 
				echo ' | '; 
				echo anchor(site_url('user/delete/'.$user->idUser),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
