...
<div class="container content">
  ...
  <div class="list-group">
    ...
    <a href="javascript:DataDiri()" class="list-group-item ">
      <i class="fa fa-clock-o tab10" aria-hidden="true"></i> Data Diri </a>
    <a href="javascript:logBook()" class="list-group-item ">
  ...
  <div class="list-group">
    <a href="javascript:unduh()" class="list-group-item list-group-item-header">Unduh</a>  
    <!--
