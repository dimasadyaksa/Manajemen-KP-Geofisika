...
<div class="container content">
  ...
  <div class="list-group">
    ...
    <a href="<?php echo site_url('Mahasiswa/create')?>" class="list-group-item " id="data">
    ...
    <a href="javascript:logBook()" class="list-group-item " id="logbook">
      ...
      <a href="javascript:tempatKP()" class="list-group-item " id="tempatKP"><i class="fa fa-calendar tab10" aria-hidden="true"></i>Tempat Kerja Praktik</a>
  </div>

  <div class="list-group">
    <a href="#" class="list-group-item list-group-item-header">Sistem</a>  
    <a href="javascript:PLapangan()" class="list-group-item " id="PL"><i class="fa fa-user-circle tab10" aria-hidden="true"></i>Pembimbing Lapangan</a>
    
  </div>

  <div class="list-group">
    <a href="#" class="list-group-item list-group-item-header">Seminar</a>  
    <a href="javascript:seminar()" id="seminar" class="list-group-item "  ><i class="fa fa-user-circle tab10" aria-hidden="true"></i>Daftar Seminar</a>
  </div>

  <div class="list-group">
    <a href="javascript:unduh()" class="list-group-item " id="unduh">Unduh</a>  
    <!--
