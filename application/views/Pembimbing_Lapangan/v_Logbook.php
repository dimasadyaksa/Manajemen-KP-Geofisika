    ...
    <tbody>
      <tr>
        ...
        <td style="text-align: left">14116075</td>
        <td style="text-align: left">PT. Pertamina</td>
        <td><a role="button" class="btn btn-info" href="<?php echo site_url('Pembimbing_Lapangan/logbook')?>">Lihat</a></td>
      </tr>
    </tbody>
  </table>
</div>
